             ...
             <form onSubmit={this.onSubmit}>
               ...
               <div className="form-group">
                   ...
                   <div className="form-check">
                     <input tpye="checkbox" className="form-check-input" id="completedCheckbox" name="completedCheckbox" onChange={this.onChangeTodoCompleted} checked={this.state.todo_completed} value={this.state.todo_completed}/>
